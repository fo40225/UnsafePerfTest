...
.NET Core
    ...
    ------------------------------------- |------ |---------:|----------:|----------:|
         ...
         UnsafeAccessArrayWorkroundOffset | 10000 | 1.165 ms | 0.0229 ms | 0.0215 ms |
     UnsafeAccessArrayWorkroundRawPointer | 10000 | 1.166 ms | 0.0216 ms | 0.0191 ms |
...
.NET Framework
    ...
    ------------------------------------- |------ |---------:|----------:|----------:|---------:|
         ...
         UnsafeAccessArrayWorkroundOffset | 10000 | 1.872 ms | 0.0253 ms | 0.0236 ms | 1.863 ms |
     UnsafeAccessArrayWorkroundRawPointer | 10000 | 1.876 ms | 0.0132 ms | 0.0110 ms | 1.878 ms |
